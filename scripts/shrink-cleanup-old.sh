...
OLD_INSTANCE_ID="${OLD_INSTANCE_ID:?Set OLD_INSTANCE_ID to the retired instance ID}"
OLD_VOLUME_ID="${OLD_VOLUME_ID:?Set OLD_VOLUME_ID to the retired root volume ID}"
CUTOVER_DATE="${CUTOVER_DATE:?Set CUTOVER_DATE (YYYY-MM-DD)}"
